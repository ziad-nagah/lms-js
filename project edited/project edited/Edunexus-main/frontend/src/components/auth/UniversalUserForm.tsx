...
const UniversalUserForm = ({ type, initialData, onSuccess, role }: Props) => {
  ...
  async function onSubmit(data: FormValues) {
    try {
      ...
      const { classId, subjectIds, confirmPassword, ...rest } = data;
      const payload = {
        ...rest,
        studentClass: classId || undefined,
  ...
  const showRoleSelector = !isLogin && !role;
    ...
    <form onSubmit={form.handleSubmit(onSubmit)}>
      <FieldGroup>
        <div className="grid grid-cols-2 gap-4 w-full">
          {!isLogin && (
            <div className={showRoleSelector ? "" : "col-span-2"}>
              <CustomInput
